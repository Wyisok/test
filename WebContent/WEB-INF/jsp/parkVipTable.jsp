...
<body id="page-top">
		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					...
					<href onclick=reloadTable()> 优惠列表</href>
				</div>
				<div class="card-body">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="parkId"  id="inputParkId" value=""/>
						...
						<select class="form-control" name="parkVipType"
									id="parkVipType" >
									<c:forEach items="${ParkVipTypes}" var="item">
						...
						<div class="form-group">
								<div class="input-group-prepend">
									<span class="input-group-text">优惠时长</span> 
									<input type="text" id="lengthOfTime" name="spotPlace" class="form-control">
								</div>
						</div>
						...
						<div class="form-group">
								<div class="input-group-prepend">
									...
									<input type="number" placeholder=""
										id="price" name="spotNum" class="form-control"
										max="" min="0">
							</div>
						</div>
						<div class="form-group">
								<div class="input-group-prepend">
									...
									<input type="date" placeholder=""
										id="endTime" name="spotNum" class="form-control"
										>
							</div>
						</div>
					</form>
				...
				<div class="modal-footer">
					...
					<button type="button" onclick=addParkVip() data-dismiss="modal"
	...
	<script type="text/javascript">
		...
		          "columnDefs": [
			...
			                        return '<a href="#" onclick=getParkSpot("'+data+'") data-toggle="modal" data-target="#AddModel"  class="badge badge-info" style="font-size:15px"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a href="#"  onclick=delParkVip("'+data+'") class="badge badge-danger" style="font-size:15px"><i class="fa fa-trash"></i></a>';
			                    }
			                }
			            ], 
				...
				"sAjaxSource" : "${pageContext.request.contextPath}/getParkVipTable?parkId=${park.parkId}", //这个是请求的地址    
		...
		function addParkVip(){
			var param={
				"parkId":"${park.parkId}",
				"parkVipType":$("#parkVipType").val(),
				"lengthOfTime":$("#lengthOfTime").val(),
				"price":$("#price").val(),
				"endTime":$("#endTime").val(),
			};
			
			$.post("${pageContext.request.contextPath}/addParkVip",
				param,				
				function(data){
				reloadTable();
			}
		 ...
		 <!-- 删除车位信息 删除按钮-->
		 function delParkVip(parkVipId){
			 $.ajax({
					url : "${pageContext.request.contextPath}/deleteParkVip?parkVipId="+parkVipId,
					type : "POST",
					success : function(result) {
						reloadTable();
					}
