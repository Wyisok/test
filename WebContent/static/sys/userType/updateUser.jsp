				...
				<div class="ItemBlock2">
                    ...
                    <tr>
                            ...
                            <select name="cid" style="width:80px">
	                          <c:choose>
						    <c:when test="${not empty sessionScope.listFoodType}">
							
							<c:forEach var="food" items="${sessionScope.listFoodType}">
			   						<option value="${food.id}">${food.typeName}</option>
                             ...
                             *<input type="hidden" name="id" value="${requestScope.foodType.id }" /></td>
						</tr>
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodName" class="InputStyle" value="${requestScope.foodType.foodName }"/> *</td>
						</tr>
						<tr>
							<td>价格</td>
							<td><input type="text" name="price" class="InputStyle" value="${requestScope.foodType.price }"/> *</td>
						</tr>
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="mprice" class="InputStyle" value="${requestScope.foodType.mprice}"/> *</td>
						</tr>
